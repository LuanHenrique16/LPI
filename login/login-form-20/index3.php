...
if(isset($_POST['sub'])){
    ...
    $i="insert into reg(username,password)value('$username','$password')";
    mysqli_query($con, $i);
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Registrar</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form method="POST" class="signin-form">
                    ...
                    <div class="form-group">
                        <button type="submit" name="sub" class="form-control btn btn-primary submit px-3">Login</button>
